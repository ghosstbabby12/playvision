...
class _MatchesPageState extends State<MatchesPage> {
        ...
        builder: (ctx, setDialogState) {
          ...
          return AlertDialog(
            ...
            title: Text('New match',
                style: TextStyle(color: dc.text, fontWeight: FontWeight.w700)),
              ...
              child: Column(mainAxisSize: MainAxisSize.min, children: [
                DropdownButtonFormField<int>(
                  ...
                  items: _controller.teams.map((t) => DropdownMenuItem<int>(
                    value: t['id'] as int,
                    child: Text(t['name'] ?? '—', style: TextStyle(color: dc.text)),
                  )).toList(),
                ...
                DropdownButtonFormField<String>(
                  ...
                  style: TextStyle(color: dc.text),
                  items: [
                    DropdownMenuItem(value: AppConstants.sourceUpload,  child: Text('Upload',  style: TextStyle(color: dc.text))),
                    DropdownMenuItem(value: AppConstants.sourceYoutube, child: Text('YouTube', style: TextStyle(color: dc.text))),
                  ],
                ...
                ListTile(
                  ...
                  trailing: Icon(Icons.calendar_today_outlined, color: dc.accent, size: 18),
                  onTap: () async {
                ...
                ListTile(
                  ...
                  title: Text('Time: ${selectedTime.format(ctx)}',
                      style: TextStyle(color: dc.text, fontSize: 14)),
                  trailing: Icon(Icons.access_time_outlined, color: dc.accent, size: 18),
                  onTap: () async {
            ...
            actions: [
              TextButton(
                ...
                child: Text('Cancel', style: TextStyle(color: dc.dim)),
              ),
              GestureDetector(
                onTap: () async {
                ...
                child: Container(
                  ...
                  child: Text('Save',
                      style: TextStyle(color: dc.text, fontWeight: FontWeight.w600)),
                ),
              ),
            ],
          );
  ...
  InputDecoration _fieldDecoration(String label, AppColorTokens c) => InputDecoration(
    labelText: label,
