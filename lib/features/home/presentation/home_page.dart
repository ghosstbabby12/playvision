          ...
          child: Row(children: [
            Container(
              ...
              child: leagueLogo.isNotEmpty
                  ? Image.network(leagueLogo, errorBuilder: (_, __, ___) => const Icon(Icons.emoji_events, color: AppColors.accent, size: 16))
      ...
      child: Row(children: [
        SizedBox(
          ...
          child: Column(crossAxisAlignment: CrossAxisAlignment.center, children: [
            ...
            Text(timeLabel,
                style: TextStyle(color: (statusShort == '1H' || statusShort == '2H') ? statusColor : AppColors.muted, fontSize: 12, fontWeight: FontWeight.bold)),
            Text(dateLabel,
    ...
    return Row(children: [
      if (logoUrl.isNotEmpty)
        ...
        Container(
          ...
          child: Center(child: Text(name.isNotEmpty ? name[0] : '?', style: const TextStyle(color: AppColors.accent, fontSize: 10, fontWeight: FontWeight.w700))),
        ),
...
class _NoticiasSection extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Padding(
      padding: const EdgeInsets.fromLTRB(20, 16, 20, 0),
      child: Column(children: articles.map((a) => _ArticleCard(
      ...
      child: Row(children: [
        ...
        Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          Text(title, maxLines: 2, overflow: TextOverflow.ellipsis,
              style: const TextStyle(color: AppColors.text, fontSize: 13, fontWeight: FontWeight.w600, height: 1.3)),
          const SizedBox(height: 4),
