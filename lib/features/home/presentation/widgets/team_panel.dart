...
class _MatchItemState extends State<MatchItem> {
  ...
  Widget build(BuildContext context) {
    ...
    final opponent =
        widget.match['opponent'] as String? ?? l10n.matchUnknownOpponent;
    final dateStr = widget.match['match_date'] as String? ?? '';
    final status =
        widget.match['status'] as String? ?? AppConstants.statusUploaded;
    ...
    final formattedDate = dt != null
        ? DateFormat(AppConstants.dateFormat, l10n.localeName).format(dt)
        : '';
