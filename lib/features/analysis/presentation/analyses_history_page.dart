...
class _AnalysesHistoryPageState extends State<AnalysesHistoryPage> {
  ...
  Widget build(BuildContext context) {
    ...
    final teamsWithMatches =
        _teams.where((t) => grouped.containsKey(t['id'] as int?)).toList();
              ...
              child: Row(
                children: [
                  ...
                  Container(
                    ...
                    child: Text(
                      '$done / ${widget.matches.length} ${l10n.analysed}',
                      style: TextStyle(
                        color: c.accent,
                        fontSize: 10,
                        fontWeight: FontWeight.w700,
...
class _MatchRow extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final dateLabel = dt != null
        ? DateFormat('d MMM y · HH:mm', localeTag).format(dt)
        : '—';
          ...
          children: [
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  Text(
                    opponent != null && opponent.isNotEmpty
                        ? l10n.matchVersusOpponent(opponent)
                        : l10n.matchWord,
                    style: TextStyle(
                      color: c.text,
                      fontSize: 13,
