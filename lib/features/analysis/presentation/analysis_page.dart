                        ...
                        Expanded(
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                isAnalyzing
                                    ? l10n.analysisProcessingWithAI
                                    : l10n.aiPoweredPerformance,
                                style: TextStyle(
                  ...
                  Expanded(
                    child: hasResult
                        ? TabBarView(
                            ...
                            children: [
                              ...
                              PlayersTab(
                                ...
                                matchId:
                                    _controller.result!['match_id'] as int? ??
                                        _controller.result!['match']?['id']
                                            as int?,
                              ),
                              VideoScenesTab(
                                videoUrl:
                                    (_controller.result!['video_url']
                                            as String?) ??
                                        (_controller.result!['videoUrl']
                                            as String?) ??
                                        (_controller.result!['match']?['video_url']
                                            as String?),
                        ...
                        : VideoUploadView(
                            ...
                            onAnalyze: () => _controller.analyzeVideo(l10n),
