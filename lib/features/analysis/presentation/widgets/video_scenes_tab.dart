        ...
        Padding(
          ...
          child: Container(
            ...
            child: Row(
              children: [
                _ScenePill(
                  label: l10n.sceneVideo,
                  icon: Icons.play_circle_outline,
                  active: _scene == 0,
                  onTap: () => setState(() => _scene = 0),
                ),
                _ScenePill(
                  label: l10n.sceneHeatmap,
                  icon: Icons.blur_on_rounded,
                  active: _scene == 1,
                  onTap: () => setState(() => _scene = 1),
                ),
                _ScenePill(
                  label: l10n.scenePlayer,
                  icon: Icons.person_pin_circle_outlined,
                  active: _scene == 2,
                  onTap: () => setState(() => _scene = 2),
                ),
              ],
            ),
          ),
      ...
      child: Column(
        ...
        children: [
                ...
                return GestureDetector(
                  ...
                  child: AnimatedContainer(
                    ...
                    decoration: BoxDecoration(
                      ...
                      border: Border.all(
                        color: isActive ? c.borderGreen : c.border,
                      ),
                    ),
                    child: Column(
                      mainAxisAlignment: MainAxisAlignment.center,
                      children: [
                        ...
                        Text(
                          p['zone'] as String? ?? l10n.sceneUnknownZone,
          ...
          Container(
            ...
            child: Row(
              children: [
                ...
                Expanded(
                  child: Text(
                    l10n.scenePlayerInfo(rank, zone),
                    style: TextStyle(
                      color: c.textHi,
                      fontSize: 13,
                      fontWeight: FontWeight.w700,
          ...
          if (selected['heatmap_zones'] != null) ...[
            ...
            const SizedBox(height: 10),
            _ZoneBar(
              zones: Map<String, double>.from(
                (selected['heatmap_zones'] as Map).map(
...
class _HeatmapPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    canvas.drawRect(
      ...
      Paint()..color = const Color(0xFF071409),
    );
    ...
    for (int i = 0; i < 8; i++) {
      canvas.drawRect(
        ...
        Paint()
          ..color = i.isEven
              ? const Color(0xFF091B0C)
              : const Color(0xFF071409),
      );
    }
        ...
        canvas.drawCircle(
          ...
          Paint()
            ..color = const Color(0xFFFFFF00)
                .withValues(alpha: math.min(0.03 * nearby, 0.18))
...
class _ZoneDensityGrid extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    for (final p in players) {
      final z = p['zone'] as String? ?? l10n.sceneUnknownZone;
