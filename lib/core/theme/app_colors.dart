...
class AppColors {
  ...
  // ── Fondos ───────────────────────────────────────────────
  static const Color bg       = Color(0xFF080C08);
  static const Color surface  = Color(0xFF0E1420);
  static const Color elevated = Color(0xFF141C12);
  static const Color card     = Color(0xFF101A10);

  // ── Hero gradient ────────────────────────────────────────
  static const Color heroTop    = Color(0xFF1A3A20);
  static const Color heroBottom = Color(0xFF0A160A);

  // ── Bordes ───────────────────────────────────────────────
  static const Color border      = Color(0x12FFFFFF);
  static const Color border2     = Color(0x22FFFFFF);
  static const Color borderGreen = Color(0x253DCF6E);
  ...
  // ── Acento verde ─────────────────────────────────────────
  static const Color accent    = Color(0xFF3DCF6E);
  static const Color accentHi  = Color(0xFF6EE89A);
  static const Color accentLo  = Color(0xFF1A3A20);
  static const Color accentMid = Color(0xFF22522E);
